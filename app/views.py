...
def fetch_weather_data(request):
    ...
    if request.method=='POST':
        ...
        obj=WeatherData.objects.create(username=LUO,city=city_name, temperature=temperature, humidity=humidity,weather=weather, speed=speed)
        obj.save()
        obj=WeatherData.objects.all()
        d={'obj':obj}
        return render(request,'fetch_weather_data.html',d)
